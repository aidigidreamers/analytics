...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#00FFD8' : 'black',
  ...
  onlyLight: darkMode ? '#0d0f13' : 'transparent',
  divider: darkMode ? 'rgba(43, 43, 43, 0.435)' : 'rgba(43, 43, 43, 0.035)',

  //primary colors
  primary1: darkMode ? '#00ffd8' : '#00FFD8',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#00FFD8',

  // secondary colors
  secondary1: darkMode ? '#00ffd8' : '#00FFD8',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #00FFD830 0%, #fff 0%)`,
})
